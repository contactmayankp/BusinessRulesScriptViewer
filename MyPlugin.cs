...
namespace Sdmsols.XTB.BusinessRulesScriptViewer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "BusinessRulesScriptViewer"),
        ExportMetadata("Description", "Allows to View and Export Internal Dynamics 365 Business Rules Java Scripts!"),
    ...
    public class MyPlugin : PluginBase,IPayPalPlugin
    {
        ...
        {
            return new BusinessRulesScriptViewer();
        }
